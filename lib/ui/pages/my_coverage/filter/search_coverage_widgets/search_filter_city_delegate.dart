...
import 'package:c_supervisor/ui/pages/my_coverage/filter/search_coverage_widgets/search_result_city_list.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:flutter_core/paging/paging_list_view.dart';
import 'package:get_it/get_it.dart';

/// [SearchFilterCityDelegate] is generic search used to retrieve filter search values
class SearchFilterCityDelegate<K extends CitiesCubit,
    T extends SelectCityItemCubit> extends SearchDelegate {
  SearchFilterCityDelegate({
  ...
  Widget buildResults(BuildContext context) {
    ...
    return MultiBlocProvider(
      ...
      child: SearchCityResultList<K, T>(

...
class ResetPasswordContent extends HookWidget {
  ResetPasswordContent({Key? key, required this.changePasswordArgs})
      : super(key: key);
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: PasswordTextField.withDarkBorder(
                      ...
                      Padding(
                        padding: EdgeInsets.symmetric(horizontal: 10.w),
                        child: PasswordTextField.withDarkBorder(
                          myController: confirmationPassword,
                          contentPadding: EdgeInsets.symmetric(vertical: 23.h),
                          prefixIcon: const Icon(
                            Icons.lock_open,
                          ),
                      ...
                      Padding(
                        padding: EdgeInsets.symmetric(horizontal: 10.w),
                        child: AppBlocConsumer<ChangePasswordCubit,
  ...
  _resetPassword(
      BuildContext context, String newPassword, String confirmationPassword) {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      if (newPassword == confirmationPassword) {
        context.read<ChangePasswordCubit>().changePassword(
            successCall: () {
              context
                  .showNotice(Notice(message: 'Password changed successfully'));
              context.go(
                PreAuthRoutes.login.route.path,
              );
            },
            otpModel: OtpModel(
        ...
        context.showNotice(Notice(message: 'Passwords should be matched'));
      }
    }
  }
}

...
class TeamAttendanceHeader extends StatelessWidget {
  const TeamAttendanceHeader({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Card(
        ...
        child: SizedBox(
          ...
          child: AppBlocConsumer<ChartDataCubit, BaseResponse<ChartDataList?>>(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(
                  'Total Users: ${widget.chartDataList.isNotEmpty ? widget.chartDataList.map((data) => data.count).reduce((value, element) => value! + element!) : ''}',
                ),
              )
            ],
          ),

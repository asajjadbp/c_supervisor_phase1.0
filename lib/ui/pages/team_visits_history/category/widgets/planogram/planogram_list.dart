...
import 'package:c_supervisor/ui/pages/team_visits_history/category/widgets/planogram/planogram_card.dart';
import 'package:flutter_core/tools/request_builder/request_state.dart';

import '../../../../../../data/models/visits_categories/planogram_list_model.dart';
...
final GlobalKey<RefreshIndicatorState> refreshIndicatorPlanoGramKey =
    GlobalKey<RefreshIndicatorState>();

class PlanoGramList extends StatefulWidget {
  const PlanoGramList({
    Key? key,
  ...
  @override
  State<PlanoGramList> createState() => _PlanoGramListState();
}

class _PlanoGramListState extends State<PlanoGramList> {
  ...
  Widget build(BuildContext context) {
    return AppBlocConsumer<PlanoGramCubit, BaseResponse<PlanoGramListModel?>>(

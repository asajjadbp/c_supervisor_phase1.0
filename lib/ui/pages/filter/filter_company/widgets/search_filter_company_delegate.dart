...
import 'package:c_supervisor/ui/pages/filter/filter_company/widgets/search_result_company_list.dart';
...
/// [SearchFilterCompanyDelegate] is generic search used to retrieve filter search values
class SearchFilterCompanyDelegate<K extends CompanyCubit,
    T extends SelectCompanyItemCubit> extends SearchDelegate {
  SearchFilterCompanyDelegate({
  ...
  Widget buildResults(BuildContext context) {
    ...
    return MultiBlocProvider(
      ...
      child: SearchCompanyResultList<K, T>(
